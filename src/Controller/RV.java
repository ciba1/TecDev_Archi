...
public class RV extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {timeValue = new java.sql.Time(formatter.parse(dt[0]+":"+dt[1]+":00").getTime());
	    HttpSession session = request.getSession();
	   	 Class.forName("com.mysql.jdbc.Driver");
	      java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost/mydb","root","");
	  
	      PreparedStatement prepareStmt = con.prepareStatement ("INSERT INTO `rendez_vous`(`idpatient`, `idmedecin`, `date`, `heure`) VALUES (?,?,?,?)");   
	     ...
	     prepareStmt.setInt (2, (Integer)session.getAttribute("medJSP"));
	      ...
	      out.print("<p>un rendez-vous a été pris préalablement de ");  out.print(timeValue);  out.print(" pendant un jour ouvrable  le ");out.print(java.sql.Date.valueOf(jr[2]+"-"+jr[0]+"-"+jr[1])); out.print(" chez le Medecin "); 
