...
<link rel="stylesheet" type="text/css"
	href="archProjMaster/style/home.css">
<!-- fontawesome -->
<link rel="stylesheet"
...
<!-- DAtatable -->
<link rel="stylesheet" type="text/css"
	href="archProjMaster/style/datatable.css">
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
	href="archProjMaster/css/style.css" />
<script
...
<script>
	$
			.get(
					"http://localhost:8080/e_health/GetMedcin.jsp",
	...
	<div class="">
		...
		<div class="card bg-dark text-white border border-0">
			<img src="archProjMaster/assets/medecin/medecin_card.jpg"
				class="card-img img-fluid" alt="stethoscope-fond-bleu"
				style="min-height: 350px">
			<div class="card-img-overlay p-5">
				<h1 class="card-title">
					<strong>DiagnoVit</strong>
				</h1>
				<br> <br>
				<p class="card-text">Trouvez rapidement un medecin en algerie et
					...
					<div class="col-lg-8">
						<form action="versListeMedecins" id="form_id" method="post">
							<div class="input-group mb-2">
								<input id="tags" name="Rmed" type="text"
									class="form-control form-control-lg"
									placeholder="Thesis's search">
								<div class="input-group-prepend">
									<div
										class="input-group-text rounded-right m-0 border border-secondary"
										style="background-color: #5f5aaa">
			...
			if (reche != null) {
				...
				if (med.size() != 0) {
					...
					for (medecin item : med) {
						...
						out.print("<div class='col'>");
						out.print("<h3 class='card-text'>");
						out.print("<strong> Medecin ");
						out.print("</strong> <br>");
						...
						out.print("<p class=''>");
						out.print("<strong> Du ");
						out.print("</strong> Dimanche-Jeudi");
						out.print("<strong> 08h-12h ");
						out.print("</strong>  et ");
						out.print("<strong> 13h-17h ");
						out.print("</strong>");
						out.print("</p>");
						out.print("</div>");
						out.print("</div>");
						...
						out.print("<p class=''>");
						out.print("<strong>LE ");
						out.print("</strong> Samedi et Mardi");
						out.print("<strong> 08h-12h ");
						out.print("</strong> et ");
						out.print("<strong> 13h-17h");
						out.print("</strong>");
						...
						out.print("<div class='col'>");
						out.print(
								"<button class='btn btn-info' data-toggle='modal' data-target='#exampleModal'> See More");
						out.print("</button>");
						out.print("</div>");
						out.print("</div>");
						out.print("</div>");
						...
						out.print("<h5 class='modal-title' id='exampleModalLabel'> Modal title");
						out.print("</h5>");
						out.print("<button type='button' class='close' data-dismiss='modal' aria-label='Close'>");
						out.print("<span aria-hidden='true'> &times; ");
						out.print("</span>");
						out.print("</button>");
						out.print("</div>");
						...
						out.print(
								"<img class='rounded-circle' src='archProjMaster/assets/medecin/doc.jpg' alt='' width='100px' height='100px' style='border: 4px solid #5f5aaa' >");
						out.print("</div>");
						out.print("<div class='col-auto mb-3'>");
						out.print("<h4>");
						out.print("<strong>");
						...
						out.print("</h4>");
						out.print("</div>");
						out.print("<div class='col-auto mb-3'>Medecin <br>");
						out.print(item.getSpecialité());
						out.print("</div>");
						out.print("<div class='col-auto mb-3'>");
						...
						out.print("<div class='col-auto'>");
						out.print("<div class='row justify-content-center'>");
						out.print("<p>Samedi et Mardi");
						out.print("</p>");
						out.print("</div>");
						out.print("<div class='row justify-content-center'>");
						out.print("<p>");
						out.print("<strong> 09h30-12h ");
						out.print("</strong> et");
						out.print("<strong> 13h-15h30 ");
						out.print("</strong>");
						out.print("</p>");
						out.print("</div>");
						out.print("</div>");
						...
						out.print("<div class='col-6'>");
						out.print(
								"<select name='heure' form='fRV' class='form-control' id='exampleFormControlSelect1'>");
						...
						out.print(
								"<iframe width='600' height='500' id='gmap_canvas' src='https://maps.google.com/maps?q=usdb&t=&z=13&ie=UTF8&iwloc=&output=embed' frameborder='0' scrolling='no' marginheight='0' marginwidth='0'>");
						out.print("</iframe>");
						out.print("</div>");
						out.print("</div>");
						out.print("</div>");
						...
						out.print("<div class='row' id='successful' style='display: none'>"+
			                            "<div class='col-12'>"+
			                        		...
			                        		"<button form='fRV' type='submit'  type='button' class='btn btn-primary'"+
											" id='Appointment' data-toggle='modal' data-target='#confirm'> Appointment </button>"+
					                    "</div>"+
					                "</div>");
						out.print("</div>");
						out.print("</div>");
    ...
    <div class="card bg-dark text-white border border-0">
        ...
        <div class="card-img-overlay p-5">
			...
			function getMedecin(){
				...
				document.getElementById("form_id").submit();
=======
>>>>>>> 6a93ce7c40d20e6846a3caa8656f383122353b5a
				}
			}
		%>
		<br> <br>
		...
		<div class="row justify-content-center pt-3 us_contact">
			...
			<div class="col-md-2">
				...
				<div class="row justify-content-center">
					<p class="p_social_media">Tel: +213-XX-XX-XX-XX</p>
				</div>
			</div>
			...
			<div class="col-md-2">
				...
				<div class="row justify-content-center">
					<p class="p_social_media">TecDev@info.dz</p>
				</div>
			</div>
			...
			<div class="col-md-2">
				...
				<div class="row justify-content-center">
					<p class="p_social_media">USDB, BLIDA, ALGERIA...</p>
				</div>
			</div>
			...
			<div class="col-md-2">
				...
				<div class="row justify-content-center">
					<p class="p_social_media">TecDev_Groupe8</p>
				</div>
			</div>
		</div>
		<div class="row justify-content-center powredby"
			style="background-color: #37346b">
			<img src="archProjMaster/assets/tecdevlogo.svg" alt="tecdevlogo"
				height="70" width="180">
		</div>
